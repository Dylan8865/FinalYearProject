    ...
    <div className="min-h-screen flex items-center justify-center bg-[#1E1E20] sm:bg-[#18181A] p-0">
      <div className="w-full max-w-md bg-[#1E1E20] sm:rounded-lg sm:shadow-md border-none sm:border sm:border-[#3B3B3B] p-4 sm:p-6 max-h-screen overflow-auto [&::-webkit-scrollbar]:hidden -ms-overflow-style-none scrollbar-none">
        <div className="mb-6 text-left">
          ...
          <h1 className="text-lg sm:text-xl font-semibold text-white">Sign up to Wisdom Island</h1>
          <p className="text-[10px] sm:text-xs font-normal text-[#5D5D5D] mt-1">Start sharing your knowledge</p>
        </div>
        ...
        <form className="space-y-3" onSubmit={handleSubmit}>
          <div>
            <label htmlFor="username" className="text-[12px] text-white mb-1 block">Username</label>
            <input
              type="text"
              id="username"
              name="username"
          ...
          <div>
            <label htmlFor="email" className="text-[12px] text-white mb-1 block">Email</label>
            <input
              type="email"
              id="email"
              name="email"
          ...
          <div>
            <label htmlFor="password" className="text-[12px] text-white mb-1 block">Password</label>
            <input
              type="password"
              id="password"
              name="password"
          ...
          <div>
            <label htmlFor="confirmPassword" className="text-[12px] text-white mb-1 block">Confirm Password</label>
            <input
              type="password"
              id="confirmPassword"
          ...
          <div className="flex justify-center mt-4">
            <p className="text-[12px] text-[#5D5D5D]">
              ...
              <a href="/login" className="text-[#6D3F33] visited:text-[#6D3F33] hover:underline font-bold">
                Sign in
              </a>
            </p>
          </div>
