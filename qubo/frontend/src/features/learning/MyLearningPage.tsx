...
import { FiBookOpen, FiBox, FiClock, FiHeart, FiMoreVertical, FiPlay, FiTrash2, FiX } from 'react-icons/fi';
...
export default function MyLearningPage() {
  ...
  useEffect(() => {
    Promise.all([authService.getRecentLearning(), authService.getFavourites(), authService.getSharedLearningItems()])
      .then(([recentItems, favouriteItems, receivedItems]) => { setRecent(recentItems); setFavourites(favouriteItems); setSharedItems(receivedItems); })
