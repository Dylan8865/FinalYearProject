...
import { ThreeDModelSummary } from '@/types/resource';
import ModelThumbnail from './ModelThumbnail';
import { FiAlertCircle, FiArrowLeft, FiArrowRight, FiBox, FiRefreshCw, FiSearch, FiShare2, FiTrash2, FiX } from 'react-icons/fi';
