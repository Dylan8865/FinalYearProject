...
import { FiArrowRight, FiBookmark, FiBox, FiChevronRight, FiClock, FiHeart, FiPlay, FiSearch, FiStar, FiZap } from 'react-icons/fi';
    ...
    <div className="min-w-0">
      <header className="sticky top-0 z-20 border-b border-slate-200/80 bg-white/90 px-5 py-4 backdrop-blur md:px-8">
        <div className="mx-auto flex max-w-7xl items-center justify-between gap-4">
          <label className="flex h-11 w-full max-w-md items-center gap-3 rounded-full bg-slate-100 px-4 text-slate-400"><FiSearch className="h-4 w-4" /><input placeholder="Search resources, topics, or subjects" onFocus={() => navigate('/models')} className="min-w-0 flex-1 bg-transparent text-sm font-medium outline-none" /></label>
