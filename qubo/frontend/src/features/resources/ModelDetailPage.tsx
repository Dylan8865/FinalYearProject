...
import { FiAlertCircle, FiArrowLeft, FiBookOpen, FiEdit2, FiHeart, FiMapPin, FiPlus, FiRefreshCw, FiSave, FiStar, FiTrash2, FiX } from 'react-icons/fi';
