...
const MALAY_TRANSLATIONS: Record<string, string> = {
  ...
  'Subjects': 'Subjek',
  'Analytics': 'Analitik',
  'Student Analytics': 'Analitik Pelajar',
  ...
  'Subject view': 'Paparan subjek',
  'Scroll sideways to switch subjects.': 'Tatal ke sisi untuk menukar subjek.',
  'Overall summary': 'Ringkasan keseluruhan',
  'All-subject overview': 'Gambaran keseluruhan semua subjek',
  'Your overall learning picture': 'Gambaran pembelajaran keseluruhan anda',
  'Mastery averages only measured topics. Subjects without activity are shown as coverage gaps, not counted as zero.': 'Purata penguasaan hanya menggunakan topik yang telah diukur. Subjek tanpa aktiviti ditunjukkan sebagai jurang liputan dan tidak dikira sebagai sifar.',
  'Practice a subject': 'Latih tubi subjek',
  'Subjects measured': 'Subjek diukur',
  'Strongest measured subject': 'Subjek diukur paling kuat',
  'Needs the most attention': 'Paling memerlukan perhatian',
  'Complete a quiz to begin measuring mastery.': 'Selesaikan kuiz untuk mula mengukur penguasaan.',
  'More measured activity is needed for comparison.': 'Lebih banyak aktiviti diukur diperlukan untuk perbandingan.',
  ...
  'Search videos, models, topics…': 'Cari video, model, topik…',
  ...
  'Drag to rotate · Scroll to zoom': 'Seret untuk memutar · Tatal untuk zum',
  ...
  'Selected uploads': 'Muat naik dipilih',
  'Upload JPEG/PNG images or PDFs. Maximum 8 MB per file and 16 MB in total.': 'Muat naik imej JPEG/PNG atau PDF. Maksimum 8 MB setiap fail dan 16 MB keseluruhan.',
  ...
  'Questionnaire-based learning preference': 'Keutamaan pembelajaran berdasarkan soal selidik',
  'Study recommendation': 'Cadangan pembelajaran',
  'Take assessment': 'Ambil penilaian',
  'Retake': 'Ambil semula',
  ...
  'Daily quiz practice': 'Latihan kuiz harian',
  'Nightly progress review': 'Semakan kemajuan setiap malam',
  'Save reminders': 'Simpan peringatan',
  'Browser alerts': 'Makluman pelayar',
  'Loading reminder settings…': 'Memuatkan tetapan peringatan…',
  'Study reminders are unavailable.': 'Peringatan belajar tidak tersedia.',
  'Study reminders could not be loaded.': 'Peringatan belajar tidak dapat dimuatkan.',
  'Reminder settings saved.': 'Tetapan peringatan disimpan.',
  'Reminder settings could not be saved.': 'Tetapan peringatan tidak dapat disimpan.',
  'Choose the answer that fits you best before continuing.': 'Pilih jawapan yang paling sesuai dengan anda sebelum meneruskan.',
  'Your learning preference could not be saved. Please try again.': 'Keutamaan pembelajaran anda tidak dapat disimpan. Sila cuba lagi.',
