        ...
        return (
          <group position={position}>
            ...
            {[0, 1, 2].map((layer) => (
              <group
                key={layer}
                position={[0, 0.3 + layer * 0.05, 0]}
                rotation={[0, layer * 0.3, 0]}
              >
                {[0, 1, 2, 3, 4].map((i) => (
                  <mesh
                    key={i}
        ...
        return (
          <group position={position}>
            ...
            {[-0.15, -0.05].map((y, i) => (
              <mesh
                key={i}
                position={[0.1 * (i % 2 === 0 ? 1 : -1), y, 0]}
                rotation={[0, 0, 0.5 * (i % 2 === 0 ? 1 : -1)]}
                castShadow
              >
      ...
      case "Red Mushroom":
        return (
          <group position={position}>
            ...
            <mesh position={[0, -0.1, 0]} castShadow receiveShadow>
              <sphereGeometry
                args={[0.2, 16, 12, 0, Math.PI * 2, 0, Math.PI / 2]}
              />
              <meshStandardMaterial color="#dc2626" />
            </mesh>
            {/* White spots */}
        ...
        return (
          <group position={position}>
            ...
            <mesh position={[0, -0.15, 0]} castShadow receiveShadow>
              <sphereGeometry
                args={[0.15, 16, 12, 0, Math.PI * 2, 0, Math.PI / 2]}
              />
              <meshStandardMaterial
                color="#8b5cf6"
                emissive="#8b5cf6"
        ...
        return (
          <group position={position}>
            ...
            {[
              ...
              >
                <coneGeometry
                  args={[crystal.scale * 0.4, crystal.scale * 2, 6]}
                />
                <meshStandardMaterial
                  color="#a855f7"
                  emissive="#a855f7"
